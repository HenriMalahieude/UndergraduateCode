...
int main (int argc, char *argv[])
{
    ...
    /*************************************************************************/
    //INSERT CODE HERE
    cuda_ret = cudaMalloc((void **)&A_d, sizeof(float)*mat_sz);
    cuda_ret = cudaMalloc((void **)&B_d, sizeof(float)*mat_sz);
    cuda_ret = cudaMalloc((void **)&C_d, sizeof(float)*mat_sz);
    ...
    startTime(&timer);
    basicMatAdd(matDim, A_d, B_d, C_d); // <--------------------------------------Actual Kernel Call
